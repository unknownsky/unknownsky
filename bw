	...
	window.BWEUM.require = a, window.apmFirstbyte = window.apmUserFirstbyte || (new Date).getTime(), window.apmBICookieUser = "AIPortal_Res_Account", window.apmBIUserFindLazy = "AIPortal_Res_Account", window.apmBISessionTime = 30, a = function b(c, d, e) {
		...
		33: [function(a, b) {
			...
			function e() {
				...
				var f = (a("lodash._slice"), a("ee").create()),
					g = a("prase-url-original"),
					h = a("gos"),
					i = a("handle"),
					j = a("map-own");
				a("wrap-function")(f)
			...
			var k = window,
				l = "fetch-",
				m = l + "body-",
				n = ["arrayBuffer", "blob", "json", "text", "formData"],
				o = k.Request,
				p = k.Response,
				q = k.fetch,
				r = "prototype";
			o && p && q && (j(n, function(a, b) {
				...
				var c, f;
				this.totalCbs = 0, this.called = 0, this.cbTime = 0, this.ended = !1, this.xhrGuids = {}, this.startTime = e(), this.metrics = {}, this.metrics.txSize = 0, "object" == typeof a ? (c = a.url, f = a.method) : (c = a, void 0 == b && (b = {}), f = b.method || "get", b && b.body && "string" == typeof b.body && (this.metrics.txSize = b.body.length)), this.params = {
					method: f
				}, d(this, c)
		...
		10: [function(a) {
			...
			if (i && i.prototype && !/CriOS/.test(navigator.userAgent)) {
				...
				var j = a("decodeurlfn"),
					k = a("handle"),
					l = a("prase-url-original"),
					m = a("ee"),
					n = ["load", "error", "abort", "timeout"],
					o = n.length,
					p = a("loader_id"),
					q = a("wrap-function")(m);
		...
		9: [function(a) {
			...
			if (b && b.timing && b.getEntriesByType) {
				var c = a("ee"),
					d = (a("handle"), a("wrap-timer"), a("loader"));
